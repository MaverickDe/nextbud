      ...
      <RootLayout3>
        <div className="w-full flex bg-[#F5EFFB] items-center justify-center px-5 py-5 max-sm:px-3 flex-col">
          ...
          <div className="p-10 flex-col flex justify-center items-center">
            <h1 className="text-[50px] max-md:text-[30px]">Acceptable Use Policy</h1>
          ...
          <div className="w-[80%] max-sm:w-[90%] bg-[white] m-5 flex flex-col mb-20 gap-10  py-10 px-10 max-sm:px-5 rounded-[40px] max-w-[1500px] rounded-lg font-nueuthin">
            <div className="flex flex-col gap-5">
              <p>
              This acceptable use policy covers the products, services, and technologies (collectively referred to as the "Products") provided by NextBud under any ongoing agreement. It’s designed to protect us, our customers and the general Internet community from unethical, irresponsible and illegal activity.
NextBud customers found engaging in activities prohibited by this acceptable use policy can be liable for service suspension and account termination. In extreme cases, we may be legally obliged to report such customers to the relevant authorities.
              </p>
...
<div  className="flex flex-col gap-5">
                                  ...
                                  <h2 className="font-nueubig">Copyright infringement and access to unauthorised material</h2>
                              <div className="flex flex-col gap-5">
...
<div  className="flex flex-col gap-5">
                                  <h1 className="font-nueubig">SPAM and unauthorised message activity</h1>
...
<p>This spam and unauthorised message activity policy applies to messages sent using our Products, or to messages sent from any network by the customer or any person on the customer’s behalf, that directly or indirectly refer the recipient to a site hosted via our Products.</p>
...
<div  className="flex flex-col gap-5">
                                  <h1 className="font-nueubig">Unethical, exploitative, and malicious activity</h1>
                                  
                              <div className="flex flex-col gap-5">
                              <p>Our Products must not be used for the purpose of advertising, transmitting or otherwise making available any software, program, product or service designed to violate this acceptable use policy, or the acceptable use policy of other service providers. This includes but isn’t limited to facilitating the means to send spam and the initiation of network sniffing, pinging, packet spoofing, flooding, mail-bombing and denial-of-service attacks.</p>

<p>Our Products must not be used to access any account or electronic resource where the group or individual attempting to gain access does not own or is not authorised to access the resource (e.g. "hacking", "cracking", "phreaking", etc.).</p>
...
<p>Other activities considered unethical, exploitative and malicious include:</p>
                            ...
                            <div className="flex flex-col gap-5">
              <h1 className="font-nueubig">Unauthorised use of NextBud property</h1>
              <div className="flex flex-col gap-5">
                <p>
                We prohibit the impersonation of NextBud, the representation of a significant business relationship with NextBud, or ownership of any NextBud property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage or user trust.
                </p>
...
We reserve the right to modify this policy at any time by publishing the revised version on our app or website. The revised version will be effective from the earlier of:
                </p>
