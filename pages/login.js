...
//         <meta name="description" content={WEBTITLE + ` login.`} />
//         <meta property="og:title" content={WEBTITLE + ` login.`} />
//         <meta
//           property="og:description"
//           content={
//             "Login into " + WEBTITLE + `to access task and make daily earns.`
//           }
//         />
//       </Head>
//       {/* <Layout> */}
...
//           <h1 className="mt-5 font-bold text-[25px]">login</h1>
...
//               value={data.key}
//               onChange={(e) => {
//                 setdatahelper("key")(e.currentTarget.value);
//               }}
//               className="w-full shadow-md rounded-md bg-light2 dark:bg-dark2 h-[50px] p-3"
//               placeholder="example@gmial.com or john"
//               type="text"
//             />
//           </div>
//           <div>
...
//                 let resp = await fetch_(SERVERLOGINURL, {
//                   method: "post",
//                   // redirect: 'manual',
//                   redirect: "manual",
//                   credentials: "include",
...
//               }
//             }}
//             className="submitbtn bg-secondary dark:bg-primary  text-primary dark:text-secondary shadow-md rounded-md w-fit px-5 py-2 flex gap-2 justify-center items-center"
//           >
//             <span>login</span>
...
//             <Link href="passwordotp" className="mb-10">
//               forgot password
//             </Link>
//           </div>
//         </form>
