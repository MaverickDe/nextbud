...
const Nav = () => {
  ...
  return (
    <section className="w-full fixed top-[0px]   left-[0px]  z-30 box-border">
      <section className="w-full bg-[rgba(255,255,255,0.9)] backdrop-blur-sm  box-b relative text-[black] min-h-[40px] box-border flex  justify-between items-center px-5 py-3">
