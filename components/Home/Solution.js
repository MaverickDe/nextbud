...
const Overview = () => {
  return (
    <section className="relative w-full flex max-md:flex-col justify-center items-center gap-[10px] my-5 p-5 py-20 shadow-md bg-[black] rounded-[30px]">
      ...
      Join us as we embark on a journey of connection, empowerment, and celebration.
        ...
        <button className="text-[#9864F1] rounded-md px-5 py-3 my-5 text-bold border-[1px] border-[#9864F1] w-fit">Get started as an Influencer</button>
