...
import img2 from "../../public/images/images/AboutUsImage.png";
...
const Overview = () => {
  return (
    <section
      id="aboutus"
      className="relative w-full flex max-md:flex-col-reverse justify-center items-center gap-[10px] my-5 px-5 md:px-20 py-10 shadow-md bg-[black] rounded-[80px] max-md:rounded-[60px] "
    >
      ...
      <div className="w-full md:max-w-[480px] text-[white] gap-5 flex flex-col justify-center items-center gap-[10px]    max-w-[1300px] ">
        ...
        <div className=" font-nueuthin text-[#d1d1d1] text-[16px] relative self-start">
          <p className=" font-nueuthin ">
            At NextBud, we're on a mission to unite Africans around the world
            and create a vibrant community where connections flourish,
            opportunities abound, and cultures thrive. Our platform is more than
            just a social networking app — it's a gateway to meaningful
            relationships, empowering experiences, and endless possibilities.
          </p>
          <br />
          <p className=" font-nueuthin">
            Founded in 2024, NextBud was born out of a passion for bringing
            people together and bridging geographical boundaries. We understand
            the importance of staying connected to your roots while exploring
            new horizons, and that's why we've created a platform that
            celebrates the diversity, resilience, and creativity of the African
            diaspora.
          </p>
             
        </div>
