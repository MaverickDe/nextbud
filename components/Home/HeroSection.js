...
const HeroSection = () => {
  return (
    <section className="w-full mt-[170px]   min-h-[60vh] py-5 px-3 flex flex-col justify-center items-center  text-[black] dark:text-[white]   bg-center bg-cover">
      <h1 className={`${poppins.className} font-bold  text-[1rem]  text-center max-sm:text-[3.5rem] sm:text-[3rem] md:text-[4rem]  font-bold flex gap-5 max-sm:flex-col max-sm:gap-0`}>
      ...
      <div className="w-full relative flex justify-center items-center flex-col">
          ...
          <Image src={heroimage2} className="w-full md:hidden mt-10 " priority      loading="eager" />
